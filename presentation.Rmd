...
<aside class="notes">
There are ways to do that in SQL and Power Query.
</aside>
...
<aside class="notes">
Still a year of data but a lot more products.
</aside>
...
<aside class="notes">
Specific dates, TODAY function, from the data. Then there is also CALENDARAUTO(), Auto date/times, and setting a date table.
</aside>
...
<aside class="notes">
Add in month, change format (always want to match)
</aside>
...
<aside class="notes">
Can see the star shape. Easy to use with functions.
</aside>
...
<div class="fragment" style="margin-bottom: 7%;">
- Table - Base table with missing data (based on orders table here)
</div>
<div class="fragment" style="margin-bottom: 7%;">
...
<aside class="notes">
Add in amount filled (could replace amount).
</aside>
